...
public class CapabilityCyber implements ICyber {
    ...
    public static void initCapability() {
        CapabilityManager.INSTANCE.register(ICyber.class, new Capability.IStorage<ICyber>() {
            @Nullable
            @Override
            public INBT writeNBT(Capability<ICyber> capability, ICyber instance, Direction side) {
                if (instance != null)
            ...
            @Override
            public void readNBT(Capability<ICyber> capability, ICyber instance, Direction side, INBT nbt) {
                if (instance != null)
    ...
    @Override
    public void setCyber(boolean isCyber) {
